...
def crear_recopilación_top_noticias():
    ...
    """Loq ue ncesito hacer es identificar entidades, precios, timestamps y el reconocimiento de percepciones negativas o positivas
     con respecto a esas entidades."""
    ...
    with open("Recopilaciones/{}.txt".format(datetime.datetime.now().date()),
        ...
        for fuente in diccionario_fuentes_noticias.keys():
            ...
            for noticia in diccionario_fuentes_noticias[fuente]:
                # Se revisa si la noticia no está repetida ya que pueden haber copias de diferentes fuentes
                """***** NO APLICA PARA PROGRAMA DE AUTO-INVERSIONES YA QUE NOS INTERESA SABER LA CANTIDAD DE VECES QUE SE PUBLICA LA NOTICIA"""
        ...
        top_noticias = [n for n in lista_ordenada_todas_las_noticias if n[
            'puntaje'] > 0]
        """PARA ESTE PROGRAMA NO ES RELEVANTE IDENTIFICAR TEMAS-->ARREGLAR DICCIONARIOS
        ESTO SE REALIZABA PARA ORDENAR NOTICIAS EN DOCUMENTO TXT"""
